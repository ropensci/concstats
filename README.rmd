...
which - used as a set - might reduce uncertainty. The goal of the `concstats`
...
package has just one function, neither of both packages offer a finite sample
correction.
...
However, almost none of these packages offer finite sample correction, with the
...
7.  Melnik, A., Shy, Oz, Stenbacka, R., (2008), Assessing market dominance,
    Journal of Economic Behavior and Organization, 68: pp. 63-72.
