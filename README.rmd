...
[GitHub](https://github.com/ropensci/concstats) or [R-universe](https://ropensci.r-universe.dev/ui#package:concstats).
```{r eval = FALSE}
...
[CONTRIBUTING file](https://github.com/ropensci/concstats/blob/main/.github/CONTRIBUTING.md).
