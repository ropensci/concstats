...
Herfindahl Hirschmann Index. The goal of the `concstats` package is to offer a
...
Hirschmann Index.  
\-`inequ` offers diversity or inequality measures, e.g. the Entropy or the
Palma ratio.
...
group are measures like the Herfindahl-Hirschmann index (HHI), the dual of the
...
Herfindahl-Hirschmann Index, in decimal form, 7) Normalized Entropy (RE),
