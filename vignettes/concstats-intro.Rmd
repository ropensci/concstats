...
shares, by default `concstats` treats 0 as NA. The result is a cumulative top 5
market share of 96 %.  
...
```{r example-2}
x <- c(0.35, 0.4, 0.05, 0.1, 0.06, 0.04, 0, 0)
test_share_top3 <- concstats_mstruct(x, type = "top3") # top3 market shares in %
test_share_top3
```

```{r example-top3-df}
x <- c(0.35, 0.4, 0.05, 0.1, 0.06, 0.04)
id <- c("firm1", "firm2", "firm3", "firm4", "firm5", "firm6")
...
# a normalized value
test_share_hhi2 <- concstats_hhi(x, normalized = TRUE)
test_share_hhi2
...
two sample years 2016 and 2018. It seems that most of the cooperatives have
increased their amounts of total loans granted.
