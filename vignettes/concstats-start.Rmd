...
inequality**. **A single standard measure like the Herfindahl Hirschman Index (HHI)
may lead to erroneous conclusions.** The `concstats` package offers a
...
**entropy**, **gini coefficient**, **berry index**, the **palma ratio** and the
